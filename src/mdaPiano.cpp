...
#define PIANO_INDEX(value) ((value) / PIANO_SAMPLE_RESAMPLING)
#define PIANO_START(value) (((value) + PIANO_SAMPLE_RESAMPLING - 1) / PIANO_SAMPLE_RESAMPLING)
...
void mdaPiano::noteOn(int32_t note, int32_t velocity)
{
  ...
  if(velocity>0)
  {
    ...
    l = 22050.0f * iFs * (float)exp(0.05776226505 * l) / PIANO_SAMPLE_RESAMPLING;
