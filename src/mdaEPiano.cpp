...
#define EPIANO_INDEX(value) ((value) / EPIANO_SAMPLE_DECIMATION)
#define EPIANO_START(value) (((value) + EPIANO_SAMPLE_DECIMATION - 1) / EPIANO_SAMPLE_DECIMATION)
...
void mdaEPiano::noteOn(int32_t note, int32_t velocity)
{
  ...
  if(velocity > 0)
  {
    ...
    l = 32000.0f * iFs * (float)exp(0.05776226505 * l) / EPIANO_SAMPLE_DECIMATION;
